...
class NeighborSampler:
    ...
    def get_all_first_hop_neighbors(self, node_ids: np.ndarray, node_interact_times: np.ndarray):
        ...
        for idx, (node_id, node_interact_time) in enumerate(zip(node_ids, node_interact_times)):
            ...
            # nodes_neighbor_ids_list.append(torch.Tensor(node_neighbor_ids).long())
            # nodes_edge_ids_list.append(torch.Tensor(node_edge_ids).long())
            # nodes_neighbor_times_list.append(torch.Tensor(node_neighbor_times))
